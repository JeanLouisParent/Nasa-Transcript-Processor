...
|:---------|:-------|:------|
| 1 (lowest) | `PipelineConfig` class | Built-in fallbacks |
...
| Key | Type | Default | Description |
|:----|:-----|:--------|:------------|
| `deskew_angle_threshold` | float | `0.5` | Minimum angle (degrees) to trigger rotation |
| `clahe_clip_limit` | float | `2.0` | CLAHE contrast limit (legacy) |
| `bilateral_d` | int | `9` | Bilateral filter diameter (legacy) |
...
| Key | Type | Default | Description |
|:----|:-----|:--------|:------------|
| `col1_end` | float | `0.15` | Timestamp column end ratio (0-1) |
| `col2_end` | float | `0.30` | Speaker column end ratio (0-1) |
| `header_ratio` | float | `0.10` | Header zone ratio (0-1) |
...
| `col1_end` | float | Timestamp column end ratio |
